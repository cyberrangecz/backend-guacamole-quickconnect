...
public class QuickSimpleConnection extends AbstractConnection {
     ...
     * as older versions of QuickSimpleConnection. <strong>This storage should be
    ...
    /**
     * Creates a completely uninitialized QuickSimpleConnection. The name,
     * identifier, and configuration of this QuickSimpleConnection must eventually
     * be set before the QuickSimpleConnection may be used. Parameter tokens within
     ...
     */
    public QuickSimpleConnection(boolean interpretTokens) {
        this.interpretTokens = interpretTokens;
    }

    /**
     * Creates a new QuickSimpleConnection having the given identifier and
     ...
     */
    public QuickSimpleConnection(String name, String identifier, GuacamoleConfiguration config) {
     ...
     *     tokens will not be interpreted at all.
     */
    public QuickSimpleConnection(String name, String identifier, GuacamoleConfiguration config, boolean interpretTokens) {
        super.setName(name);
     ...
     * the connection, as provided when this QuickSimpleConnection was created or via
     * {@link #setConfiguration(org.apache.guacamole.protocol.GuacamoleConfiguration)}.
     *
     * @return
    ...
    public GuacamoleTunnel connect(GuacamoleClientInformation info) throws GuacamoleException {
        ...
        String hostname = this.fullConfig.getParameter(GUACD_HOSTNAME_NAME) == null ? proxyConfig.getHostname() : this.fullConfig.getParameter(GUACD_HOSTNAME_NAME);
        int port = this.fullConfig.getParameter(GUACD_PORT_NAME) == null ? proxyConfig.getPort() : Integer.parseInt(this.fullConfig.getParameter(GUACD_PORT_NAME));
     ...
     * the QuickSimpleConnection was explicitly requested to do so when created.
     *
